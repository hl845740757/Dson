# Dson(Data Script Object Notation)
...
| -^  | switch mode | 纯文本模式下插入转义行；<br/>双引号模式下插入纯文本行；<br/>当前行有效 |                |
...
| es  | extString | 11 | *<b>带类型标签的string</b>* | {<br> int32 type;<br> string value <br>}                                             | 格式固定二元数组 \[@es type, value] <br> -- \[@es 10, @ss ^\[\\u4e00-\\u9fa5_a-zA-Z0-9]+$ <br/> ~~ ]                  |
