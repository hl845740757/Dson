...
| es  | extString | 11 | 带类型标签的string | {<br> int32 type;<br> string value <br>}                                             | 格式固定二元数组 \[@es type, value] <br> \[@es 10, "abcd"]                                                            |
...
| 标签 | 类型                         | 含义                                                                                                 | 格式或示例                                                                                                           |
|----|----------------------------|----------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| ss | string string <br/> (text) | 纯文本 <br> 1. 不会对字符进行转义，所见即所得 <br/>2. 遇见 -- 独立行行首表示结束 <br/>3. 既可修饰value，**也可修饰key** <br/>4. 相当于特殊的引号 | -- {<br> -- url:  @ss https://github.com/hl845740757 <br> -- , reg: @ss ^\[\u4e00-\u9fa5_a-zA-Z0-9]+$ <br> -- } |
